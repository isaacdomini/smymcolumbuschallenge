...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        ...
        // Release any resources associated with this scene that can be re-created automatically on
        // the next connection.
    ...
    // Continue supporting openURL for Capacitor plugins
    ...
    // Continue supporting Universal Links
